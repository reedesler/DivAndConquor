...
bool Window::init(vec2 screen, Game* game) {
    this->screen = screen;
    this->game = game;
    ...
    auto key_redirect = [](GLFWwindow *wnd, int _0, int _1, int _2, int _3) {
        ((Window *) glfwGetWindowUserPointer(wnd))->onKey(wnd, _0, _1, _2, _3);
    };
    auto cursor_pos_redirect = [](GLFWwindow *wnd, double _0, double _1) {
        ((Window *) glfwGetWindowUserPointer(wnd))->onMouseMove(wnd, _0, _1);
    };
...
void Window::onKey(GLFWwindow *, int key, int scancode, int action, int mod) {
